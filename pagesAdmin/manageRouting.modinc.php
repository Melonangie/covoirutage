...
<script src="./javascript/tourneesManagement.js" type="text/javascript"></script>

<h1> Gérer les tournées </h1>
<article>
    <p> Vous pouvez consulter et administrer les requêtes de covoiturage.
        <?php echo " Solution ".$numsolution; ?> 
    </p>
    <div id="g_map" style="height: 800px; width: 100%;"></div>
    <div id="operate_panel1" style="float: left; width: 50%; text-align: center; padding-top: 10px">
    <span class="paragraphe"> 
        <input type="checkbox" id="ptsdepart" onclick="operateDiv()" /> 
        Points de départ 
        <input type="checkbox" id="ptsarrivee" onclick="operateDiv1()" /> 
        Point d'arrivée 
        <input type="checkbox" id="itineraires" onclick="operateDiv2()" />
        Itinéraires 
    </span>
    <div id="operate_panel" style="width: 100%; padding-top: 10px; visibility: hidden; float: left;">
    <table border="1">
        <tr>
        ...
        <tr>
            <td>Afficher/Non afficher tout</td>
            <td>
                <input type="checkbox" id="tout_reel" onclick="SelectAllrel_check(this.id)">
            </td>
            <td>
                <input type="checkbox" id="tout_pre" onclick="SelectAllPre_check(this.id)">
            </td>
        </tr> 
    </table>
        
    <table cellpadding="0" cellspacing="0" border="0" class="display"  id="trajetTable">
        <thead>
            <tr>
                <?php
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <div id="disrel">
                    <?php $total_distance_pre_km=$total_distance_pre/1000; echo $total_distance_pre_km; ?>
                </div>
            </td>
            <td>
                <div id="dispre"></div>
        ...
        <tr>
            ...
            <td>
                <div id="durrel"></div> 
                <?php $total_duration_pre_min=round($total_duration_pre/60); echo $total_duration_pre_min; ?>
            </td>
            <td>
                <div id="durpre"></div>
            </td>
    ...
    <div id="id_tournee" style="text-align: left; padding-top: 10px; float: right; width: 40%;">
    </div>
    <div id="detail" style="text-align: left; padding-top: 10px; float: right; width: 40%;">
    </div>
